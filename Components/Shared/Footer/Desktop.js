...
const Desktop = () => {
  return (
    ...
    <Container className='px-5'>
        <Row>
            ...
            <Col className='px-3'>
                ...
                <Link href={'https://www.facebook.com/peacelandtraveltourism.official/'} target='_blank'><FaFacebook className='wh-txt mx-2 cur fs-18' /></Link>
                <Link href="https://www.instagram.com/peacelandtravelandtourism/?fbclid=IwAR0Ol2E3QiKOWgGxlBu0vvIvYvwbKERTs_yo_-lnzLRY-5LOvbjykfR_7Nc" target='_blank'><FaInstagram className='wh-txt mx-2 cur fs-18' /></Link>
                <Link href={'https://twitter.com/peacelandgroup'} target='_blank'><FaSquareXTwitter className='wh-txt mx-2 cur fs-18' /></Link>
                <Link href="https://www.linkedin.com/company/peaceland-travels-and-tourism/" target='_blank'><FaLinkedin className='wh-txt mx-2 cur fs-18' /></Link>
            </Col>
            <Col className='px-3'>
    ...
    <div className='bgBt p-3 text-center wh-txt'> Copyright 2024 Peaceland Travel, All Rights Reserved </div>
    </div>
    </>
  )
}
